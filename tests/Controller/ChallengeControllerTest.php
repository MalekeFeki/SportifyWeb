...
class ChallengeControllerTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = $this->manager->getRepository(Challenge::class);
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'challenge[nom]' => 'Testing',
            'challenge[difficulty]' => 'Testing',
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'challenge[nom]' => 'Something New',
            'challenge[difficulty]' => 'Something New',
