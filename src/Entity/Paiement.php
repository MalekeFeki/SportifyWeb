...
class Paiement
{
    ...
    #[ORM\Column(name: "NCB", type: "string", length: 255, nullable: false)]
    #[Assert\NotBlank]
    #[Assert\Length(max: 16)]
    #[Assert\Type(type: "digit", message: "NCB must contain only digits")]
    private ?string $ncb;

    #[ORM\Column(name: "CVC", type: "string", length: 255, nullable: false)]
    #[Assert\NotBlank]
    #[Assert\Length(exactly: 3)]
    #[Assert\Type(type: "digit", message: "CVC must contain only digits")]
    private ?string $cvc;
    ...
    #[Assert\NotBlank]
    #[Assert\Length(max: 4)]
    #[Assert\Type(type: "digit", message: "Postal code must contain only digits")]
    ...
    #[ORM\OneToOne(targetEntity: "Adhesion")]
    #[ORM\JoinColumn(name: "adhesion_id", referencedColumnName: "idA", nullable: false)]
    private ?Adhesion $ida;
